...
public class ShadowUtil {
     ...
     */
    public static void setShadowSelectorBg(View view, int backgroundColorNormal, int backgroundColorEnable, int shadowColorNormal, int shadowColorEnable, float cornerRadius, float shadowSize, float maxShadowSize) {
